...
def test_esn_client_prediction_process() -> None:
    ...
    beta_1 = torch.Tensor([[0.2248], [-0.1362], [0.0851]]).double()
    ...
    beta_2 = torch.Tensor([[0.2844], [-0.2300], [-0.0031]]).double()
