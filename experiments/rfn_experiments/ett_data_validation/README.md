...
```
bash experiments/rfn_experiments/ett_data_validation/game_run_hp_sweep.sh \
experiments/rfn_experiments/ett_data_validation/game_config.yaml \
experiments/rfn_experiments/ett_data_validation/results/ \
~/venv/fedmoe_env/
```
...
```
bash experiments/rfn_experiments/ett_data_validation/non_game_run_hp_sweep.sh \
experiments/rfn_experiments/ett_data_validation/non_game_config.yaml \
experiments/rfn_experiments/ett_data_validation/results/ \
~/venv/fedmoe_env/
```
...
```
RESULTS_DIR="experiments/rfn_experiments/ett_data_validation/results/$EXPERIMENT_NAME"
```
