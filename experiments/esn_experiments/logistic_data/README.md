...
*** With GAME ***
```
bash experiments/esn_experiments/logistic_data/game_run_hp_sweep.sh \
experiments/esn_experiments/logistic_data/game_config.yaml \
experiments/esn_experiments/logistic_data/results/ \
~/venv/fedmoe_env/
```

*** NO GAME ***
```
bash experiments/esn_experiments/logistic_data/non_game_run_hp_sweep.sh \
experiments/esn_experiments/logistic_data/non_game_config.yaml \
experiments/esn_experiments/logistic_data/results/ \
~/venv/fedmoe_env/
```
...
```
python -m experiments.find_best_hp --hp_sweep_dir experiments/esn_experiments/logistic_data/results/experiment_name
```
...
```
bash experiments/esn_experiments/logistic_data/game_two_clients_best_hp.sh \
experiments/esn_experiments/logistic_data/game_config.yaml \
experiments/esn_experiments/logistic_data/best_results/ \
~/venv/fedmoe_env/
```
...
```
bash experiments/esn_experiments/logistic_data/local_run_hp_sweep.sh \
experiments/esn_experiments/logistic_data/config.yaml \
experiments/esn_experiments/logistic_data/results/
```
