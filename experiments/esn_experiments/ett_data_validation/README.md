...
*** With Game ***
```
bash experiments/esn_experiments/ett_data_validation/game_run_hp_sweep.sh \
experiments/esn_experiments/ett_data_validation/game_config.yaml \
experiments/esn_experiments/ett_data_validation/results/ \
~/venv/fedmoe_env/
```

*** No Game ***
```
bash experiments/esn_experiments/ett_data_validation/non_game_run_hp_sweep.sh \
experiments/esn_experiments/ett_data_validation/non_game_config.yaml \
experiments/esn_experiments/ett_data_validation/results/ \
~/venv/fedmoe_env/
```
