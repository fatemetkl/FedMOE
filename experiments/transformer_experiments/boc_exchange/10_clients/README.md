...
experiments/transformer_experiments/boc_exchange/10_clients/pre_train_config.yaml \
experiments/transformer_experiments/boc_exchange/10_clients/models/ \
~/venv/fedmoe_env/
...
```
bash experiments/transformer_experiments/boc_exchange/run_hp_sweep.sh \
experiments/transformer_experiments/boc_exchange/10_clients/config.yaml \
~/venv/fedmoe_env/
```
...
```
python -m experiments.find_best_hp --hp_sweep_dir experiments/transformer_experiments/boc_exchange/10_clients/results/experiment_name
```
...
experiments/transformer_experiments/boc_exchange/10_clients/config.yaml \
experiments/transformer_experiments/boc_exchange/10_clients/results/
```
