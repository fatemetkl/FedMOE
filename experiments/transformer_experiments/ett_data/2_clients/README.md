...
experiments/transformer_experiments/ett_data/2_clients/pre_train_config.yaml \
experiments/transformer_experiments/ett_data/2_clients/models/ \
~/venv/fedmoe_env/
...
experiments/transformer_experiments/ett_data/2_clients/game_config.yaml \
experiments/transformer_experiments/ett_data/2_clients/results/ \
~/venv/fedmoe_env/
```
***Non-GAME***
```
bash experiments/transformer_experiments/ett_data/non_game_run_hp_sweep.sh \
experiments/transformer_experiments/ett_data/2_clients/non_game_config.yaml \
experiments/transformer_experiments/ett_data/2_clients/results/ \
~/venv/fedmoe_env/
```
...
```
python -m experiments.find_best_hp --hp_sweep_dir experiments/transformer_experiments/ett_data/2_clients/results/experiment_name
```
...
***GAME***
```
bash experiments/transformer_experiments/ett_data/2_clients/game_best_hps.sh \
experiments/transformer_experiments/ett_data/2_clients/game_config.yaml \
experiments/transformer_experiments/ett_data/2_clients/best_results/ \
~/venv/fedmoe_env/
```

***Non-GAME***
```
bash experiments/transformer_experiments/ett_data/2_clients/non_game_best_hps.sh \
experiments/transformer_experiments/ett_data/2_clients/non_game_config.yaml \
experiments/transformer_experiments/ett_data/2_clients/best_results/ \
~/venv/fedmoe_env/
```
...
```
bash experiments/transformer_experiments/ett_data/local_run_hp_sweep.sh \
experiments/transformer_experiments/ett_data/2_clients/config.yaml \
experiments/transformer_experiments/ett_data/2_clients/results/
```
