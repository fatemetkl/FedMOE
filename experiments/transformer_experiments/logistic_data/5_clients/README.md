...
```
python -m experiments.find_best_hp --hp_sweep_dir experiments/transformer_experiments/logistic_data/5_clients/results/experiment_name
```
...
***GAME***
```
bash experiments/transformer_experiments/logistic_data/5_clients/game_best_hps.sh \
experiments/transformer_experiments/logistic_data/5_clients/game_config.yaml \
