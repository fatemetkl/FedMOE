...
experiments/transformer_experiments/covariate_shift/5_clients/pre_train_config.yaml \
experiments/transformer_experiments/covariate_shift/5_clients/models/ \
~/venv/fedmoe_env/
...
experiments/transformer_experiments/covariate_shift/5_clients/game_config.yaml \
experiments/transformer_experiments/covariate_shift/5_clients/results/ \
~/venv/fedmoe_env/
```
...
experiments/transformer_experiments/covariate_shift/5_clients/non_game_config.yaml \
experiments/transformer_experiments/covariate_shift/5_clients/results/ \
~/venv/fedmoe_env/
```
...
```
python -m experiments.find_best_hp --hp_sweep_dir experiments/transformer_experiments/covariate_shift/5_clients/results/experiment_name
```
...
***GAME***
```
bash experiments/transformer_experiments/covariate_shift/5_clients/game_best_hps.sh \
experiments/transformer_experiments/covariate_shift/5_clients/game_config.yaml \
experiments/transformer_experiments/covariate_shift/5_clients/best_results/ \
~/venv/fedmoe_env/
```

***Non-GAME***
```
bash experiments/transformer_experiments/covariate_shift/5_clients/non_game_best_hps.sh \
experiments/transformer_experiments/covariate_shift/5_clients/non_game_config.yaml \
experiments/transformer_experiments/covariate_shift/5_clients/best_results/ \
~/venv/fedmoe_env/
```
...
experiments/transformer_experiments/covariate_shift/5_clients/config.yaml \
experiments/transformer_experiments/covariate_shift/5_clients/results/
```
